...
export const ClipboardListIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0cA3.369 3.369 0 0 0 5.75 3c0-1.03.822-1.875 1.875-1.875h.375m10.125 0c.375 0 .75.068 1.123.19M3.375 6.108c0-1.135.845-2.098 1.976-2.192a48.424 48.424 0 0 1 1.123-.08M11.25 3.75c0-1.03.822-1.875 1.875-1.875h.375m-3.375 0c.375 0 .75.068 1.123.19m9 6.316c0 .52.43.938.938.938h.375a.938.938 0 0 0 .938-.938v-.937c0-.521-.43-.938-.938-.938h-.375a.938.938 0 0 0-.938.938v.937Zm0 3.75c0 .52.43.938.938.938h.375a.938.938 0 0 0 .938-.938v-.938c0-.521-.43-.938-.938-.938h-.375a.938.938 0 0 0-.938.938v.938Zm0 3.75c0 .52.43.938.938.938h.375a.938.938 0 0 0 .938-.938v-.938c0-.521-.43-.938-.938-.938h-.375a.938.938 0 0 0-.938.938v.938Z" />
  </svg>
);

export const CheckBadgeIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => ( // For Habits
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const CogIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h3m-6.75 3h9.75m-1.5 3h-6.75m-1.5 3h9.75M17.25 9v9M6.75 9v9M3 12h.75M20.25 12h.75M3 6.75A.75.75 0 0 1 3.75 6h16.5a.75.75 0 0 1 .75.75v10.5a.75.75 0 0 1-.75.75H3.75a.75.75 0 0 1-.75-.75V6.75Z" />
  </svg>
);
...
export const GripVerticalIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const SunIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-6.364-.386 1.591-1.591M3 12h2.25m.386-6.364 1.591 1.591M12 12a2.25 2.25 0 0 0-2.25 2.25c0 1.31.934 2.365 2.148 2.365A2.25 2.25 0 0 0 12 12Z" />
  </svg>
);
